...
class WeatherWidgetPlugin(WidgetPlugin):
    ...
    def create_widget(self, **kwargs) -> WeatherWidget:
        """Create an instance of the WeatherWidget."""
        return WeatherWidget(**kwargs)

    def get_property_schema(self) -> Dict[str, Any]:
        """Return the property schema for the WeatherWidget."""
